...
namespace HeaderedGridView.Droid
{
    public class DisposableTypedArray : IDisposable, IEnumerable<int>
    {
        ...
        {
            return _array.GetBoolean(index, defValue);
        }

        public Color GetColor(int index, int defValue)
        {
            return _array.GetColor(index, defValue);
        }
        ...
        {
            return _array.GetDimension(index, defValue);
        }
        ...
        {
            return _array.GetDimensionPixelSize(index, defValue);
        }

        public Drawable GetDrawable(int index)
        {
            return _array.GetDrawable(index);
        }
        ...
        {
            return _array.GetFraction(index, @base, pbase, defValue);
        }

        public int GetIndex(int at)
        {
            return _array.GetIndex(at);
        }

        public int GetInt(int index, int defValue)
        {
            return _array.GetInt(index, defValue);
        }

        public int GetInteger(int index, int defValue)
        {
            return _array.GetInteger(index, defValue);
        }

        public int GetLayoutDimension(int index, int defValue)
        {
            return _array.GetLayoutDimension(index, defValue);
        }

        public int GetLayoutDimension(int index, string name)
        {
            return _array.GetLayoutDimension(index, name);
        }
        ...
        {
            return _array.GetResourceId(index, defValue);
        }
        ...
        {
            return _array.GetText(index);
        }

        public string[] GetTextArray(int index)
        {
            return _array.GetTextArray(index);
        }

        public ICharSequence[] GetTextArrayFormatted(int index)
        {
            return _array.GetTextArrayFormatted(index);
        }
        ...
        #endregion Typed Array Wrappers
    }
}